...
VALUES (
        ...
        5,
        '第5問',
        'input関数を呼び出して、1つの整数を受け取り変数nに格納したあと、出力例のように、1行目に1個の「*」、1行増えるごとに「*」の数を1ずつ増やして、n行目にn個の「*」、その後は左から1ずつ「*」を空白文字に置き換えていき、平行四辺形のような並びを出力するプログラムを作成してください。<br>0または負の値がnに格納された場合には、「invalid」を出力して改行し、プログラムを終了してください。1の場合には、「*」と改行だけを出力しなさい。',
        'https://paiza.io/projects/e/QCu2fNiPZ9VrL3QQTEh2Sw?theme=twilight',
        E'4\n',
        E'*\n**\n***\n****\n ***\n  **\n   *\n',
        E'7\n',
