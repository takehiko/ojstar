...
VALUES (
        ...
        4,
        '第4問',
        'scanf関数を呼び出して、1つの整数を受け取り変数nに格納したあと、出力例のように、1行目にn個の「*」、1行増えるごとに「*」の数を1ずつ減らして、n行目に1個の「*」、その後は1ずつ減らして、二等辺三角形のような並びを出力するプログラムを作成してください。<br>0または負の値がnに格納された場合には、「invalid」を出力して改行し、プログラムを終了してください。1の場合には、「*」と改行だけを出力しなさい。',
        'https://paiza.io/projects/e/Evck7TD6YSM3n5v3phhgEQ?theme=twilight',
        E'4\n',
        E'*\n**\n***\n****\n***\n**\n*\n',
        E'9\n',
        ...
        5,
        '第5問',
        'scanf関数を呼び出して、1つの整数を受け取り変数nに格納したあと、出力例のように、1行目にn個の「*」、1行増えるごとに「*」の数を1ずつ増やして、n行目にn個の「*」、その後は左から1ずつ「*」を空白文字に置き換えていき、平行四辺形のような並びを出力するプログラムを作成してください。<br>0または負の値がnに格納された場合には、「invalid」を出力して改行し、プログラムを終了してください。1の場合には、「*」と改行だけを出力しなさい。',
        'https://paiza.io/projects/e/Evck7TD6YSM3n5v3phhgEQ?theme=twilight',
        E'4\n',
        E'*\n**\n***\n****\n ***\n  **\n   *\n',
        E'7\n',
        ...
        E'-1\n',
        E'invalid\n',
        'n=4のとき、5行目の出力は、1個の空白文字と3個の「*」になります。他のnの値や行でもうまくいくよう、空白文字を出力するためのforループを書いて、「*」を出力するためのforループの前に置き、順に実行するようにしてください。第4問をヒントどおりに作成したら、あとの2重ループの中を変更するだけで完成します。'
    );
