...
VALUES (
        ...
        E'8\n',
        E'even\n',
        '変数は、入力を格納するためのn、2重ループのiとjのほか、それぞれの行で出力する空白文字と「*」の数を、それぞれrとsに格納するといいでしょう。1行分を出力したら、rとsの値を変えます。sの初期値と増減のルールは、問題文のとおりです。rはどうなるかを求めて、プログラムコードに反映させましょう。</li><li>「invalid」または「even」を出力したら、すぐにreturn 0;でプログラムを終了することをおすすめします。'
    );
